...
# Most of the magic methods already defined.
...
def client() -> Generator:
    # Using built-in FastAPI test client via context manager
    # `app.dependency_overrides` is how we insert mock values for real calls.
    # e.g. instead of calling `get_reddit_client`, we use the override_reddit_dependency
    # above
